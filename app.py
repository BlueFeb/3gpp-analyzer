...
if page == "🚀 통합 AI 분석기":
    ...
    st.info("💡 **RAN, SA, CT 등 3GPP의 모든 워킹그룹 기고문을 100% 완벽하게 지원합니다.** 단, 엑셀 파일 업로드 시 1열의 문서번호에 반드시 **'다운로드 원문 하이퍼링크'**가 걸려 있어야 정확하게 작동합니다.")
    ...
    if st.session_state.process_done:
        ...
        with tab1:
            ...
            # --- 유저 요청 반영: 누락 방지를 위해 완벽하게 업데이트된 프롬프트 ---
